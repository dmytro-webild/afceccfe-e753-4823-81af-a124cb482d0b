...
export default function LandingPage() {
  ...
  <div id="services" data-section="services">
      ...
      features={[
        {
          title: "Residential Development",          description: "High-quality homes built to last, with modern designs for Lagos families.",          phoneOne: { imageSrc: "http://img.b2bpic.net/free-photo/building-new-concrete-house_1398-2997.jpg", imageAlt: "commercial building construction site" },
          phoneTwo: { imageSrc: "http://img.b2bpic.net/free-photo/raw-concrete-building-construction-against-cloudy-sky_626616-500.jpg", imageAlt: "commercial building construction site" }
        },
        {
          title: "Commercial Infrastructure",          description: "Building sustainable commercial spaces for business success.",          phoneOne: { imageSrc: "http://img.b2bpic.net/free-photo/crane-construction-building_1203-2794.jpg", imageAlt: "commercial building construction site" },
          phoneTwo: { imageSrc: "http://img.b2bpic.net/free-photo/monochrome-scene-depicting-life-workers-construction-industry-site_23-2151431410.jpg", imageAlt: "commercial building construction site" }
        },
        {
  ...
  <div id="faq" data-section="faq">
      ...
      useInvertedBackground={false}
      faqs={[
        { id: "1", title: "Where are you based?", content: "We are located at Plot 11, Adigun Avenue, Ayodele Ipaye St, Magodo Phase 1, Lagos." },
        { id: "2", title: "What are your operating hours?", content: "We are open Monday to Friday, 8am–5pm and Saturday 10am–4pm." },
        { id: "3", title: "How can I get a quote?", content: "You can fill out our contact form or call us directly at 0802 752 8211." },
      ]}
  ...
  <div id="metric" data-section="metric">
      ...
      useInvertedBackground={false}
      metrics={[
        { id: "m1", value: "4.8", description: "Avg Rating" },
        { id: "m2", value: "24+", description: "Completed Projects" },
